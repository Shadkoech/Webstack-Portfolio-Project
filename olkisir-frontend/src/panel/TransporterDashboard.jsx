...
export const TransporterDashboard = () => {
  ...
  const [orderLength, setOrderLength] = useState(0); // Add state for order length
  ...
  const renderComponent = () => {
    switch (activeComponent) {
      ...
      default:
        return <Home />;
      case "orderlist":
        return <TransporterOrders setOrderLength={setOrderLength} />; // Pass setOrderLength as a prop
    }
  };
  ...
  return (
    <div>
      <nav
        ...
        className="bg-orange-400 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 h-20"
      >
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-black">Order List</span>
                <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-black bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">
                  {orderLength}
                </span>
              </a>
            </li>
