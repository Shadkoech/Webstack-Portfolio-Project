    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="flex justify-end">
        ...
        <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">
          {traderId ? "Edit Product" : "Add a new product"}
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            {loading ? (traderId ? "Updating..." : "Adding...") : (traderId ? "Update product" : "Add product")}
          </button>
        </form>
      </div>
    </div>
...
TraderEdit.propTypes = {
  traderId: PropTypes.any, // Define the type for productId
