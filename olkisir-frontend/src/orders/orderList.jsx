...
export const OrderList = () => {
    ...
    const handleUpdateOrderList = (updatedOrder) => {
    ...
    const handleAddOrderList = (newOrder) => {
                            ...
                            >
                                ...
                                <td className="px-6 py-4 text-right">
                                    <div className="text-left flex justify-between space-x-2 w-4">
                                        <button
                                            onClick={() => toggleEditForm(order.id)}
            ...
            >
                {showEditForm && (
                    <OrderEdit
                        ...
                        isOpen={showEditForm}
                        onClose={() => setShowEditForm(false)}
                        onUpdateOrder={handleUpdateOrderList}
                    />
                )}
                {showViewModal && (
                    <OrderView
